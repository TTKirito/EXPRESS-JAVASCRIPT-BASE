...
const input = {
  ...
  sources: {
    ...
    'BSCPresale01.sol': {
      content: fs.readFileSync(path.join(__dirname, '../../smart-contract/ethereum/BSCPresale01.sol')).toString()
    },
  },
  settings: {
    outputSelection: {
...
class Compile {
  ...
  getBSCPresaleInterface() {
    try {
      return output.contracts['BSCPresale01.sol']['Presale01'].abi;
    } catch (err) {
      return "Cannot get interface";
    }
  }
...
export const contracts = new Compile();
